...
function HeroSection({
  title = "Osiągnij finansową niezależność dzięki inteligentnym inwestycjom",
          ...
          <div className="space-y-6 sm:space-y-8 lg:space-y-10 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center lg:justify-start">
              <Link href={primaryCtaUrl}>
                <Button size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground px-6 sm:px-8 lg:px-10 py-4 sm:py-5 lg:py-6 rounded-xl text-base sm:text-lg lg:text-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                  <BookOpen className="mr-3 h-5 w-5 sm:h-6 sm:w-6" />
                  {primaryCtaText}
                </Button>
              </Link>
              <Link href={secondaryCtaUrl}>
                <Button size="lg" variant="outline" className="border-2 border-border hover:border-primary px-6 sm:px-8 lg:px-10 py-4 sm:py-5 lg:py-6 rounded-xl text-base sm:text-lg lg:text-xl font-semibold transition-all duration-300 hover:bg-primary/5 w-full sm:w-auto">
    ...
    <section className="bg-gradient-to-r from-primary to-primary/90 text-primary-foreground py-12 sm:py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center mb-8 sm:mb-10 lg:mb-16">
          <Link href={primaryCtaUrl}>
            <Button size="lg" className="bg-card text-primary hover:bg-card/90 font-semibold px-6 sm:px-8 lg:px-10 py-4 sm:py-5 lg:py-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 text-base sm:text-lg">
              <BookOpen className="mr-3 h-5 w-5 sm:h-6 sm:w-6" />
              {primaryCtaText}
            </Button>
          </Link>
          <Link href={secondaryCtaUrl}>
            <Button size="lg" variant="outline" className="border-2 border-primary-foreground text-primary-foreground hover:bg-primary-foreground hover:text-primary font-semibold px-6 sm:px-8 lg:px-10 py-4 sm:py-5 lg:py-6 rounded-xl transition-all duration-300 text-base sm:text-lg w-full sm:w-auto">
              <MessageCircle className="mr-3 h-5 w-5 sm:h-6 sm:w-6" />
              {secondaryCtaText}
            </Button>
          </Link>
...
export const HeroSectionInfo = {
  ...
  inputs: [
    { 
      name: 'title', 
      type: 'text', 
      defaultValue: 'Osiągnij finansową niezależność dzięki inteligentnym inwestycjom',
      friendlyName: 'Tytuł główny'
    },
    { 
      name: 'subtitle', 
      type: 'longText', 
      defaultValue: 'Wykorzystaj moje 8-letnie doświadczenie w analizie rynków finansowych. Otrzymuj profesjonalne analizy spółek, strategie inwestycyjne i edukację finansową – wszystko w jednym miejscu.',
...
export const FeaturesSectionInfo = {
  ...
  inputs: [
    ...
    { 
      name: 'subtitle', 
      type: 'longText', 
      defaultValue: 'Profesjonalne podejście do inwestowania oparte na wieloletnim doświadczeniu i sprawdzonych metodach analizy',
...
export const ServicesSectionInfo = {
  ...
  inputs: [
    ...
    { 
      name: 'subtitle', 
      type: 'longText', 
      defaultValue: 'Od analiz twojego portfela po indywidualne konsultacje – wszystko czego potrzebujesz do inteligentnego inwestowania',
      friendlyName: 'Podtytuł sekcji'
    }
  ]
}
...
export const TestimonialsSectionInfo = {
  ...
  inputs: [
    ...
    { 
      name: 'subtitle', 
      type: 'text', 
      defaultValue: 'Opinie od osób, które zaufały moim analizom i konsultacjom',
      friendlyName: 'Podtytuł sekcji'
    }
  ]
}
...
export const CTASectionInfo = {
  ...
  inputs: [
    ...
    { 
      name: 'subtitle', 
      type: 'longText', 
      defaultValue: 'Dołącz do tysięcy inwestorów, którzy już korzystają z moich analiz i osiągają lepsze wyniki finansowe',
      friendlyName: 'Podtytuł sekcji'
    },
    { 
      name: 'primaryCtaText', 

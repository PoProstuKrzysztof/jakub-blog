        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              {/* Floating badges */}
              <div
                className="absolute bg-primary text-primary-foreground px-3 py-2 rounded-lg text-sm font-medium shadow-lg"
                style={{ left: "10918px", top: "6640px" }}
              >
                ✨ Najlepsze analizy
              </div>
            ...
            {[
              ...
              >
                <CardContent className="p-8 text-center">
                  <div
                    className={`w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-primary/10 to-accent/10 flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
                  >

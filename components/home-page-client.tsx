            ...
            <div className="space-y-6 sm:space-y-8 lg:space-y-10 text-center lg:text-left">
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base sm:text-lg lg:text-xl text-muted-foreground leading-relaxed">
                  ...
                  finansowych. Otrzymuj profesjonalne analizy spółek, strategie
                  inwestycyjne i edukację finansową – wszystko w jednym miejscu.
                </p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12 lg:mb-16">
            ...
            <p className="text-sm sm:text-base lg:text-xl text-muted-foreground max-w-3xl mx-auto">
              Profesjonalne podejście do inwestowania oparte na wieloletnim
              doświadczeniu i sprawdzonych metodach analizy
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            {[
              ...
              <Card
                key={index}
                className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 group touch-manipulation"
              >
                <CardContent className="p-4 sm:p-6 lg:p-8 text-center">
                  <div
                    className={`w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 mx-auto mb-3 sm:mb-4 rounded-2xl bg-gradient-to-br from-primary/10 to-accent/10 flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
                  >
                    <feature.icon
      ...
      <section className="py-8 sm:py-12 lg:py-20">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12 lg:mb-16">
            ...
            <p className="text-sm sm:text-base lg:text-xl text-muted-foreground max-w-3xl mx-auto">
              Od analiz twojego portfela po indywidualne konsultacje – wszystko
              czego potrzebujesz do inteligentnego inwestowania
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            {[
              ...
              <Card
                key={index}
                className="border-0 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-105 group relative overflow-hidden flex flex-col touch-manipulation"
              >
          ...
          <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
            <div className="text-center mb-6 sm:mb-8 lg:mb-12">
              ...
              <p className="text-sm sm:text-base lg:text-xl text-muted-foreground mb-6 sm:mb-8">
                Poznaj moje najnowsze analizy spółek, trendy rynkowe i strategie
                inwestycyjne
              </p>
            ...
            {filteredAndSortedPosts.filter((post) => post.is_featured).length >
              0 && (
            ...
            <div>
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 sm:mb-6 gap-3 sm:gap-4">
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-foreground">
                  ...
                  {
                    filteredAndSortedPosts.filter((post) => !post.is_featured)
                      .length
                  }
                  )
                </h3>
                <Link href="/wpisy">
                  <Button
                    variant="outline"
                    className="rounded-xl text-sm sm:text-base touch-manipulation tap-highlight-none"
                  >
                    Zobacz wszystkie
      ...
      <section className="bg-gradient-to-r from-primary to-primary/90 text-primary-foreground py-12 sm:py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-base sm:text-lg lg:text-xl mb-8 sm:mb-10 text-primary-foreground/90 max-w-3xl mx-auto">
            Dołącz do tysięcy inwestorów, którzy już korzystają z moich analiz i
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-4 sm:gap-6">
            <div className="text-center lg:text-left">
              <h3 className="text-lg sm:text-xl lg:text-2xl font-bold mb-2 sm:mb-3">
                Dołącz do społeczności Kryptodegeneraci!
              </h3>
              <p className="text-sm sm:text-base lg:text-lg text-secondary-foreground/90">
                Otrzymuj najnowsze analizy, sygnały i dyskutuj z innymi
                inwestorami na Messengerze
              </p>
            </div>
            <Button
              asChild
            ...
            >
              ...
              >
                <svg
                  className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 mr-3"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                >
